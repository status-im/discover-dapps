...
let TokenFactoryJSONConfig = {
  contract_name: {
    ...
    filename:
      '/Users/lyubo/Desktop/Projects/Status/status-discover/discover-dapps/.embark/contracts/token/TokenFactory.sol',
    originalFilename: 'contracts/token/TokenFactory.sol',
    path:
      '/Users/lyubo/Desktop/Projects/Status/status-discover/discover-dapps/contracts/token/TokenFactory.sol',
    gas: 'auto',
    type: 'file',
    deploy: false,
    _gasLimit: 6000000,
