...
let ApproveAndCallFallBackJSONConfig = {
  contract_name: {
    ...
    filename:
      '/Users/lyubo/Desktop/Projects/Status/status-discover/discover-dapps/.embark/contracts/token/ApproveAndCallFallBack.sol',
    originalFilename: 'contracts/token/ApproveAndCallFallBack.sol',
    path:
      '/Users/lyubo/Desktop/Projects/Status/status-discover/discover-dapps/contracts/token/ApproveAndCallFallBack.sol',
    gas: 'auto',
    type: 'file',
    deploy: false,
    _gasLimit: 6000000,
